...
public class ChefRegistration extends AppCompatActivity {
    ...
    String[] İstanbul = {"Taksim","Üsküdar","Ümraniye","Kadıköy","Şile","Fatih"};
    String[] Mersin = {"Yenişehir","Mezitli","Tarsus","Toroslar","Erdemli","Silifke"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(statee.equals("İstanbul")){
                    ArrayList<String> list = new ArrayList<>();
                    for (String cities : İstanbul){
                        list.add(cities);
                    }
                ...
                if(statee.equals("Mersin")){
                    ArrayList<String> list = new ArrayList<>();
                    for (String cities : Mersin){
                        list.add(cities);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ChefRegistration.this,android.R.layout.simple_spinner_item,list);
                    Cityspin.setAdapter(arrayAdapter);
